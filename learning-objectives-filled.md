...
14. **Use React Router history to programmatically change the browser's URL**<br/>
    <span style="color:red;font-weight:'bold';">_This one is important because we spent so little time on it. It is better to use after something has happened, for example, a button click_</span>
